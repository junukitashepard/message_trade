...
baseline_ACT <- import_gdx_activity(scenario = 'baseline', scenario_name = 'Baseline', version = 15)

tariff_high_ACT <- import_gdx_activity(scenario = 'tariff_high', scenario_name = 'High Tariff', version = 15) 
tariff_low_ACT <- import_gdx_activity(scenario = 'tariff_low', scenario_name = 'Low Tariff', version = 9)

CO2_baseline_ACT <- import_gdx_activity(scenario = 'CO2_tax_baseline', scenario_name = 'CO2 Tax: Baseline', version = 23) 
CO2_tariff_high_ACT <- import_gdx_activity(scenario = 'CO2_tax_tariff_high', scenario_name = 'CO2 Tax: High Tariff', version = 8) 
CO2_tariff_low_ACT <- import_gdx_activity(scenario = 'CO2_tax_tariff_low', scenario_name = 'CO2 Tax: Low Tariff', version = 5) 

sanction_NAM_CPA_ACT <- import_gdx_activity(scenario = 'NAM_CPA_sanction', scenario_name = 'Sanction: NAM-CPA', version = 9)   
sanction_CPA_PAO_ACT <- import_gdx_activity(scenario = 'CPA_PAO_sanction', scenario_name = 'Sanction: CPA-PAO', version = 7)  

sanction_NAM_MEA_ACT <- import_gdx_activity(scenario = 'NAM_MEA_sanction', scenario_name = 'Sanction: NAM-MEA', version = 8)
sanction_NAM_MEA_ACT_direct <- import_gdx_activity(scenario = 'NAM_MEA_sanction_onlydirect', scenario_name = 'Sanction, direct only: NAM-MEA', version = 1)


activity <- rbind(baseline_ACT, 
                  tariff_high_ACT, tariff_low_ACT, 
                  sanction_NAM_CPA_ACT, sanction_CPA_PAO_ACT, sanction_NAM_MEA_ACT,
                  sanction_NAM_MEA_ACT_direct,
...
MEA_exports_plot <- graph_HHI(exports, energy.list = 'Crude Oil',
                                   c('baseline',
                                     'tariff_high', 'tariff_low',
                                     'NAM_MEA_sanction', 'NAM_CPA_sanction', 'CPA_PAO_sanction'),
