...
build_historical_new_capacity <- function(energy) {
  ...
  saveRDS(exports, file.path(output, paste0('analysis/msg_parameters/historical_new_capacity/', energy, '_exp.rds')))
  write.csv(exports, file.path(output, paste0('analysis/msg_parameters/historical_new_capacity/', energy, '_exp.csv')))
