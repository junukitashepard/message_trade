...
for (t in c(export_technologies, import_technologies)) {
  ...
  saveRDS(parsave, file.path(output, paste0('analysis/msg_parameters/emission_factor/', t, '.rds')))
  write.csv(parsave, file.path(output, paste0('analysis/msg_parameters/emission_factor/', t, '.csv')))
}
